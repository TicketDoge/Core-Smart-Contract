...
contract InvariantWithoutReferral is StdInvariant, Test {
    ...
    function invariant_withoutReferralTransfersRewardsToOwners() public view {
    ...
    function invariant_withoutReferralChoosesWinnerAndTransfersReward()
        public
        view
    {
